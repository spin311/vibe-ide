...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  ...
  setpath "product" "nameShort" "Vibe IDE"
  setpath "product" "nameLong" "Vibe IDE"
  setpath "product" "applicationName" "vibeide"
  ...
  setpath "product" "darwinBundleIdentifier" "com.vibeide.app"
  setpath "product" "win32AppUserModelId" "VSCodium.VSCodium"
  setpath "product" "win32DirName" "VSCodium"
  setpath "product" "win32MutexName" "vibeide"
